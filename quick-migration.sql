-- MIGRATION RAPIDE : Paiements par tranches pour dépenses
...
DROP TRIGGER IF EXISTS expense_payment_plans_update_status ON expense_payment_plans;
...
CREATE INDEX IF NOT EXISTS idx_expenses_statut_paiement ON expenses(statut_paiement);
